...
.leaf {
  ...
  width: 40px;
  height: 40px;
  background-image: url('assets/images/pixel-leaf.png');
...
<audio id="bg-audio" loop>
  <source src="assets/audio/PixelDreamsAtMidnight.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
<button id="audioBtn">🔊 Play Music</button>

<!-- Backgrounds -->
<div id="bg1" class="page-bg active-bg" style="background-image:url('assets/images/huya.png');"></div>
<div id="bg2" class="page-bg" style="background-image:url('assets/images/yessir.png');"></div>
<div id="bg3" class="page-bg" style="background-image:url('assets/images/cake.png');"></div>
<div id="bg4" class="page-bg" style="background-image:url('assets/images/game.png');"></div>
<div id="bg5" class="page-bg" style="background-image:url('assets/images/wel.png');"></div>
<div id="bg6" class="page-bg" style="background-image:url('assets/images/party-yeah.png');"></div>
<div id="bg7" class="page-bg" style="background-image:url('assets/images/sad-huhu.png');"></div>
<div id="bg8" class="page-bg" style="background-image:url('assets/images/bye-bye.png');"></div>
<div id="bg9" class="page-bg" style="background-image:url('assets/images/sad.png');"></div>
